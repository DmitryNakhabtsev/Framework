...
public class LoginTestAD extends com.brightpattern.utility.API{
		
		private DimaAfter obj1 = new DimaAfter();

		
//		public String[][] data_before = ArrayBefore();
//		public String[][] data_after = ArrayAfter();
...
//			return serviceMetricsBefore;
		...
		public void ArrayAfter() {
			...
			obj1.olgaInteraction(); // scenario execution
