...
//			  driver_aj.get("https://autotests.ssf.bugfocus.com/agentdesktop/");
			  ...
			  //driver_aj.findElement(By.xpath("//*[@id="gwt-debug-acStateMenuContainer"]/div[1]")).click(); //agent status
...
//			  driver_cc.get("https://autotests.ssf.bugfocus.com/agentdesktop/");
			  ...
			  driver_cc.findElement(By.xpath(
					  "//*[@id=\"b-navigation-item-supervisor\"]/div[1]")).click(); //supervision panel activation
			  //Thread.sleep(1000);
...
//			  driver.get("https://autotests.ssf.bugfocus.com/agentdesktop/");
	...
	protected static void agentCallAnswer(String agentName) {
		...
		switch (agentName) {
		case "alan.jenks":
			driver_aj.findElement(By.xpath("//*[@id=\"agent-desktop\"]/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[1]")).click(); // activation incoming call
			break;
		case "tony.cobb":
			driver_tb.findElement(By.xpath("//*[@id=\"agent-desktop\"]/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[1]")).click(); // activation incoming call
			break;
		case "carlos.clapper":
			driver_cc.findElement(By.xpath("//*[@id=\"agent-desktop\"]/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[1]")).click(); // activation incoming call
			break;
		default:
//			driver.findElement(By.xpath("//*[@id=\"agent-desktop\"]/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[1]"))			
			driver.findElement(By.xpath("//*[@id=\"gwt-uid-2409\"]/div[3]/button[1]")).click(); // activation incoming call
		}
	   ...
	   * @param agentName enter an agent Name
	   */
	protected static void agentCallAnswerWebRTC(String agentName) {

		switch (agentName) {
		case "alan.jenks":
			driver_aj.findElement(By.xpath("//*[@id=\"gwt-uid-2409\"]/div[3]/button[1]")).click(); // activation incoming call
			break;
		case "tony.cobb":
			driver_tb.findElement(By.xpath("//*[@id=\"gwt-uid-2409\"]/div[3]/button[1]")).click(); // activation incoming call
			break;
		case "carlos.clapper":
			driver_cc.findElement(By.xpath("//*[@id=\"gwt-uid-2409\"]/div[3]/button[1]")).click(); // activation incoming call
			break;
		default:
//			driver.findElement(By.xpath("//*[@id=\"agent-desktop\"]/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[1]"))			
			driver.findElement(By.xpath("//*[@id=\"gwt-uid-2409\"]/div[3]/button[1]")).click(); // activation incoming call
	...
	protected static String[][] getAgentsMetrics(String agentName, int numberOfAgents) {
		//*[@id="monUserTable"]/div[1]/div[3]/table/thead/tr/th[5]/div/span //metric name 
		//*[@id="monUserTable"]/div[3]/div/div[1]/div/div/table/tbody/tr/td[5]/div/div  //metric value
...
//			
	...
	protected static void setServiceToAgent(String agentName) {
		// locator of select service 
		//                     /html/body/div[4]/div/div[2]/div/div/div[2]/div[3]/div/div[2]/div/div/div[1]/div/div/div/div[2]/div/div[2]/div/div[1]/div/div[1]
		//*[@title='Service Selector']/div
//		String xpath_select = "/html/body/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[2]/div/div/div[1]/div/div/div/div[2]/div/div[2]/div/div[1]/div/div[1]";
		
		
		//*[@id="gwt-uid-459"]
		//*[@aria-label='Service A']
//		String xpath_ServiceA = "/html/body/div[9]/div/div/div/div/table/tbody/tr[7]/td";
...
//		String xpathSelectStatus ="/html/body/div[5]/div/div[2]/div/div/div[1]/div[1]/div/div[1]/img";
		...
		//*[@title='Ready']
//		String xpathReady = "/html/body/div[9]/div/table/tbody/tr/td/div/table/tbody/tr[1]/td";
...
//			Thread.sleep(1000);
	...
	protected static boolean checkHoldButton(String agentName) {
		...
		case "alan.jenks":
			// check hold
			try {
				driver_aj.findElement(By.xpath("//button[@id='cpHold']")).click();
		...
		case "tony.cobb":
			// check hold
			try {
				driver_tb.findElement(By.xpath("//button[@id='cpHold']")).click();
				System.out.println("HOLD status PASSED");
				return true;
			} catch (NoSuchElementException e) {
				// Code for Handling exception
		...
		case "carlos.clapper":
			// check hold
			try {
				driver_cc.findElement(By.xpath("//button[@id='cpHold']")).click();
				System.out.println("HOLD status PASSED");
				return true;
			} catch (NoSuchElementException e) {
				// Code for Handling exception
		...
		default:
			// check hold
			try {
				driver.findElement(By.xpath("//button[@id='cpHold']")).click();
				System.out.println("HOLD status PASSED");
				return true;
			} catch (NoSuchElementException e) {
				// Code for Handling exception
...
//			driver_aj.findElement(By.xpath("/html/body/div[11]/div/table/tbody/tr[2]/td[2]/div/div/div[1]/div/div/div[1]/div[2]/div/button/div")).click(); //blind transfer button 
		...
		case "tony.cobb":
			// Consult call
			driver_tb.findElement(By.xpath("//button[@id='cpReminder']/following-sibling::button/following-sibling::button")).click(); // initiate transfer button
			driver_tb.findElement(By.xpath("//*[@id=\"ConfirmDialogBox\"]/div/table/tbody/tr[2]/td[2]/div/div/div/div/div/div/div[2]/input")).sendKeys(calleeNumber); // it is ok too!`
			driver_tb.findElement(By.xpath("/html/body/div[11]/div/table/tbody/tr[2]/td[2]/div/div/div[1]/div/div/div[1]/div[2]/div/div/button/div/")).click(); //initiate call button
			
			break;
		case "carlos.clapper":
			// Consult call
			driver_cc.findElement(By.xpath("//button[@id='cpReminder']/following-sibling::button/following-sibling::button")).click(); // initiate transfer button
			driver_cc.findElement(By.xpath("//*[@id=\"ConfirmDialogBox\"]/div/table/tbody/tr[2]/td[2]/div/div/div/div/div/div/div[2]/input")).sendKeys(calleeNumber); // it is ok too!`
			driver_cc.findElement(By.xpath("/html/body/div[11]/div/table/tbody/tr[2]/td[2]/div/div/div[1]/div/div/div[1]/div[2]/div/div/button/div/")).click(); //initiate call button
			break;
		default:
			// Consult call
			driver.findElement(By.xpath("//button[@id='cpReminder']/following-sibling::button/following-sibling::button")).click(); // initiate transfer button
			driver.findElement(By.xpath("//*[@id=\"ConfirmDialogBox\"]/div/table/tbody/tr[2]/td[2]/div/div/div/div/div/div/div[2]/input")).sendKeys(calleeNumber); // it is ok too!`
			driver.findElement(By.xpath("/html/body/div[11]/div/table/tbody/tr[2]/td[2]/div/div/div[1]/div/div/div[1]/div[2]/div/div/button/div/")).click(); //initiate call button
		}
	}// agentConsultCall	
	...
	protected static void selectDisposition(String agentName) {
		...
		case "alan.jenks":
			// selectDisposition
			driver_aj.findElement(By.xpath("//*[@id=\"gwt-uid-92\"]")).click(); // select disposition button:
			driver_aj.findElement(By.xpath("/html/body/div[10]/div/div/div/div/table/tbody/tr[4]/td")).click(); // disposition Appointments Set
			driver_aj.findElement(By.xpath("/html/body/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[2]/div/button[16]/div")).click(); // complete interaction

			break;
		case "tony.cobb":
			// selectDisposition
			driver_tb.findElement(By.xpath("//*[@id=\"gwt-uid-92\"]")).click(); // select disposition button:
			driver_tb.findElement(By.xpath("/html/body/div[10]/div/div/div/div/table/tbody/tr[4]/td")).click(); // disposition Appointments Set
			driver_tb.findElement(By.xpath("/html/body/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[2]/div/button[16]/div")).click(); // complete interaction
			break;
		case "carlos.clapper":
			// selectDisposition
			driver_cc.findElement(By.xpath("//*[@id=\"gwt-uid-92\"]")).click(); // select disposition button:
			driver_cc.findElement(By.xpath("/html/body/div[10]/div/div/div/div/table/tbody/tr[4]/td")).click(); // disposition Appointments Set
			driver_cc.findElement(By.xpath("/html/body/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[2]/div/button[16]/div")).click(); // complete interaction
			break;
		default:
			// selectDisposition
			driver.findElement(By.xpath("//*[@id=\"gwt-uid-92\"]")).click(); // select disposition button:
			driver.findElement(By.xpath("/html/body/div[10]/div/div/div/div/table/tbody/tr[4]/td")).click(); // disposition Appointments Set
			driver.findElement(By.xpath("/html/body/div[5]/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div[1]/div/div[10]/div[2]/div/button[16]/div")).click(); // complete interaction
		}
